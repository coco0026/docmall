							...
							<div class="col-sm-12">
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											<td scope="row">
												<input type="checkbox" class="check" value="${orderVO.order_code }">
											</td>
											<td>
											...
											<td>
												<c:out value="${orderVO.mbr_id }" /> / <c:out value="${orderVO.order_mbr_nm }" />
											</td>
											<td>
												<c:out value="${orderVO.order_tot_amt }" />
											</td>
											<td>
												<c:out value="${orderVO.payment_process }" />
											</td>
											<td>
												<select class="form-control form-control-sm-md" name="order_process">
													<c:forEach items="${commonCode}" var="commonCodeVO">
														<option value="${commonCodeVO.common_code_child}" ${commonCodeVO.common_code_child == orderVO.order_process ? 'selected' : ''}>${commonCodeVO.common_code_child_nm}</option>
													</c:forEach>
												</select>
												<button type="button" name="btnChangeOrderProcess" data-order_code="${orderVO.order_code}" class="btn btn-info">변경</button>
											</td>
								...
								<button type="button" name="btnCheckDel" class="btn btn-info">선택삭제</button>
