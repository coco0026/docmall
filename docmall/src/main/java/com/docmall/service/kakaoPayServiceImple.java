...
@Log4j
@Service
public class kakaoPayServiceImple {
  ...
  - RestTemplate 를 이용한 작업. 
	...
	// 1)카카오 Pay에서 요청하는 정보
	public ReadyResponse payReady(String itemName, int quantity, String mbr_id, int totalAmount) {
		...
		parameters.add("partner_user_id", mbr_id); // 가맹점 회원Id
	...
	// 두번째 요청 : 결제 승인요청 메서드
	public ApproveResponse payApprove(String tid, String pgToken, String mbr_id) {
		...
		parameters.add("partner_user_id", mbr_id); // 주문자
	...
	private HttpHeaders getHeaders() {
		...
		headers.set("Authorization", "KakaoAK 15163f3afdd04baacd3fbea8a634441b");
